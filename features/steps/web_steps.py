...
def step_impl(context: Any) -> None:
    ...
    input_el = WebDriverWait(context.driver, context.wait_seconds).until(
        expected_conditions.presence_of_element_located((By.ID, "api_key_input"))
    )
    input_el.clear()
    input_el.send_keys(API_KEY)

    btn = context.driver.find_element(By.ID, "set_api_key-btn")
    btn.click()
